...
class InputWidget(QWidget):
    ...
    def addEgoCarBox(self):
        ...
        self.carLengthValue.setText(str(4.88))
        self.carWidthValue = QLineEdit()
        self.carWidthValue.setText(str(1.88))
        ...
        self.carValue_x.setText(str(-30))
        self.carValue_y = QLineEdit()
        self.carValue_y.setMaximumWidth(100)
        self.carValue_y.setText(str(-2.5))
        ...
        self.brakeAccValue.setText(str(-8.0))
        ...
        self.jerkValue.setText(str(3.0))
    ...
    def addTimeBox(self):
        ...
        self.predictionStepValue.setText(str(0.2))
    ...
    def _generate_car_param(self):
        ...
        param._J_MAX_S = float(self.jerkValue.text())
...
class FovUtilityModelWindow(QMainWindow):
    ...
    def addBrakeBox(self):
        ...
        self.brakeParameterGrid.addWidget(QLabel("Time brake threshold [s]"), 2, 0)
        self.brakeThreshValue = QLineEdit()
        self.brakeThreshValue.setMaximumWidth(100)
        self.brakeThreshValue.setText(str(1))
        self.brakeParameterGrid.addWidget(self.brakeThreshValue, 2, 1)
        ...
        self.brakeParameterGrid.addWidget(self.minBrakePedesValue, 4, 1)
    ...
    def on_update_clicked(self):
        ...
        param._T_BRAKE = float(self.brakeThreshValue.text())
        param._T_BRAKE_DELAY = float(self.brakeDelayValue.text())
