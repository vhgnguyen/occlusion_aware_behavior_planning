...
def scenario(l_staticObject, l_cross, l_road):
    ...
    obs1 = StaticObject(
        idx=1,
        poly=np.array([[-40, -20], [-10, -20], [-10, -7],
                       [-20, -5], [-40, -5]]))
    ...
    obs3 = StaticObject(
        idx=3,
        poly=np.array([[-40, 5], [-20, 5], [-10, 6],
                       [-10, 20], [-40, 20]]))
    l_staticObject.append(obs3)

    obs4 = StaticObject(
        idx=4,
        poly=np.array([[5, 5], [10, 5], [10, 50],
                       [5, 50]]))
    l_staticObject.append(obs4)

    # pedestrian cross
    cross1 = PedestrianCross(
        left=np.array([[-7, -6], [-7, 6]]),
    ...
    # road layout
    road1 = Road(
        left=np.array([[-100, 4], [0, 4]]),
        right=np.array([[-100, -4], [0, -4]]),
        lane=np.array([[-100, 0], [0, 0]])
    )
    road2 = Road(
        left=np.array([[-4, 0], [-4, 100]]),
        right=np.array([[4, 0], [4, 100]]),
        lane=np.array([[0, 0], [0, 100]])
    )
    road3 = Road(
        left=np.array([[0, 4], [100, 4]]),
        right=np.array([[0, -4], [100, -4]]),
        lane=np.array([[0, 0], [100, 0]])
    )
    road4 = Road(
        left=np.array([[-4, -100], [-4, 0]]),
        right=np.array([[4, -100], [4, 0]]),
        lane=np.array([[0, -100], [0, 0]])
    )
