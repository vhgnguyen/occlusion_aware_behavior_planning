...
_EVENT_RATE_HYPOPEDES_SIG_BETA = 1.2
# --- Severity model -----------
_SEVERITY_HYPOPEDES_MODEL = 'sigmoid'
_SEVERITY_HYPOPEDES_AVG_VX = 5.
_SEVERITY_HYPOPEDES_MIN_WEIGHT = 0.1
# sigmoid severity
...
_EVENT_RATE_HYPOVEH_EXP_BETA = 10.0
